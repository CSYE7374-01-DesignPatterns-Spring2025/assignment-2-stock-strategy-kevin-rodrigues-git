...
public class StockMarket {
    ...
    public static void demo(){
        ...
        CostStrategy bull = new BullMarketStrategy();
        CostStrategy bear = new BearMarketStrategy();

        GoogleStock googleStockStrategy = new GoogleStock(80, bull);
        MetaStock metaStockStrategy = new MetaStock(110, bear);
        ...
        System.out.println("Bull strategy:");
